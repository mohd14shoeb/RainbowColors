#
#  Be sure to run `pod spec lint RainbowColors.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
This library simplifies work with colors in Swift.
                   DESC

  s.homepage     = "https://github.com/igormatyushkin014/RainbowColors"
  s.screenshots  = "https://github.com/igormatyushkin014/RainbowColors/raw/master/Logo/logo-1024-300.png"
  ...
  s.source       = { :git => "https://github.com/igormatyushkin014/RainbowColors.git", :tag => s.version }
